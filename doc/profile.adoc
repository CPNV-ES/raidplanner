...
La gestion de profile devrait normalement affichier les personnages créent sur le serveur actuelle.
Et son ajout devrait être possible depuis le profile.