...
Afin d'interfacer nos calendriers/events avec le plugins jQuery,
nous utilisions le helper https://github.com/maddhatter/laravel-fullcalendar[laravel-fullcalendar] de https://github.com/maddhatter[maddhatter]
